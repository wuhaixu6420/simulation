...
public interface UserService {
	 ...
	 * @throws Exception
	 */
	DataResult<?> login(String username, String password) throws UserException, Exception;
	 ...
	 * @throws Exception
	 */
//	DataResult<?> cancellation() throws UserException, Exception;
